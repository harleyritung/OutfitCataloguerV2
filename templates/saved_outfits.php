...
<body>
  <header class="col-12">
    ...
    <div class="container-fluid">
      <ul class="nav nav-tabs justify-content-center">
        ...
        <li class="nav-item page-nav-item">
          <a class="nav-link active" href="?command=saved_outfits" aria-current="page">Saved Outfits</a>
        </li>
      </ul>
    </div>
  </header>
  ...
  <div class="col-12" id="scroll-Div">
    <div class="container spaced-from-tb">
      ...
      <div class="row">
        <div class="col-auto border p-2 m-2">
      ...
      <br>
      <br>
      <h1 class="display-6 underlined">Outfit 2.</h1>
      <p class="text-muted">#beige #casual #business-casual</p>
      <div class="row">
        <div class="col-auto border p-2 m-2">
          <a href="#" class="image-link">
            <img src="images/150x150.png" alt="150x150 grey image placeholder box." class="img-thumbnail">
      ...
      <br>
      <br>
      <h1 class="display-6 underlined">Outfit 3.</h1>
      <p class="text-muted">#pink #casual #relaxed #date</p>
      <div class="row">
        <div class="col-auto border p-2 m-2">
          <a href="#" class="image-link">
            <img src="images/150x150.png" alt="150x150 grey image placeholder box." class="img-thumbnail">
